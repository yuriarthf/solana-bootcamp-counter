...
mod test {
    ...
    fn test_counter() {
        ...
        assert_eq!(CounterAccount::try_from_slice(&accounts[0].data.borrow()).unwrap().counter, increment_value);
        ...
        assert_eq!(CounterAccount::try_from_slice(&accounts[0].data.borrow()).unwrap().counter, increment_value - decrement_value);
        ...
        assert_eq!(CounterAccount::try_from_slice(&accounts[0].data.borrow()).unwrap().counter, update_value);
